...
#include "Utils/K2Node_OrbStructReferencerGet.h"
#include "OrburierEditor/Public/Utils/OrbStructReferencerFunctionLibrary.h"
...
{
	static const FName FloatGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetFloatByName));
	static const FName IntGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetIntByName));
	static const FName BoolGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetBoolByName));
	static const FName NameGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetNameByName));
	static const FName ObjectGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetObjectByName));
	static const FName ClassGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetClassByName));
	static const FName ByteGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetByteByName));
	static const FName StringGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetStringByName));
	static const FName TextGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetTextByName));
	static const FName StructGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetStructByName));
	static const FName EnumGetterName(GET_FUNCTION_NAME_CHECKED(UOrbStructReferencerFunctionLibrary, GetEnumByName));
};
...
namespace
{
	...
	public:
		...
		virtual void RegisterNets(FKismetFunctionContext& Context, UEdGraphNode* Node) override
		{
			...
			if (const UK2Node_OrbStructReferencerGet* GetObjectVarNode = Cast<UK2Node_OrbStructReferencerGet>(Node))
			{
...
//UObject interface
void UK2Node_OrbStructReferencerGet::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UK2Node_OrbStructReferencerGet::PreEditChange(FProperty* PropertyThatWillChange)
{
...
void UK2Node_OrbStructReferencerGet::AllocateDefaultPins()
{
	...
	//TODO: Create an pin that gives the possibilities as select...
...
void UK2Node_OrbStructReferencerGet::PostPlacedNewNode()
{
...
void UK2Node_OrbStructReferencerGet::PinDefaultValueChanged(UEdGraphPin * Pin)
{
...
void UK2Node_OrbStructReferencerGet::PinConnectionListChanged(UEdGraphPin* ChangedPin)
{
...
FText UK2Node_OrbStructReferencerGet::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return LOCTEXT("OrbStructReferencerGet_Title", "Get Object Variable By Name");
}

FText UK2Node_OrbStructReferencerGet::GetTooltipText() const
{
...
FText UK2Node_OrbStructReferencerGet::GetMenuCategory() const
{
...
void UK2Node_OrbStructReferencerGet::ReallocatePinsDuringReconstruction(TArray<UEdGraphPin*>& OldPins)
{
...
bool UK2Node_OrbStructReferencerGet::HasExternalDependencies(TArray<class UStruct*>* OptionalOutput) const
{
...
FNodeHandlingFunctor* UK2Node_OrbStructReferencerGet::CreateNodeHandler(FKismetCompilerContext& CompilerContext) const
{
	return new FKCHandler_GetObjectVar(CompilerContext);
}

void UK2Node_OrbStructReferencerGet::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
...
void UK2Node_OrbStructReferencerGet::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UK2Node_OrbStructReferencerGet::NotifyPinConnectionListChanged(UEdGraphPin * Pin)
{
...
void UK2Node_OrbStructReferencerGet::ValidateNodeDuringCompilation(class FCompilerResultsLog& MessageLog) const
{
...
UEdGraphPin * UK2Node_OrbStructReferencerGet::GetThenPin() const
{
	const UEdGraphSchema_K2* K2Schema = GetDefault<UEdGraphSchema_K2>();
...
UEdGraphPin * UK2Node_OrbStructReferencerGet::GetTargetPin() const
{
...
UEdGraphPin * UK2Node_OrbStructReferencerGet::GetVarNamePin() const
{
...
UEdGraphPin * UK2Node_OrbStructReferencerGet::GetReturnResultPin() const
{
...
UEdGraphPin * UK2Node_OrbStructReferencerGet::GetReturnValuePin() const
{
	if (Pins.Num() > 5)
	{
...
FEdGraphPinType& UK2Node_OrbStructReferencerGet::GetReturnValueType() const
{
	if (Pins.Num() > 5)
	{
...
///Node type handling
/*
void UK2Node_OrbStructReferencerGet::CoerceTypeForPin(const UEdGraphPin * Pin)
{
	UEdGraphPin* OutValuePin = GetReturnValuePin();
...
//find setter
UFunction * UK2Node_OrbStructReferencerGet::FindGetterFunctionByType(FEdGraphPinType& PinType)
{
	UClass* LibraryClass = UOrbStructReferencerFunctionLibrary::StaticClass();
...
UClass* UK2Node_OrbStructReferencerGet::GetInputClass(const UEdGraphPin* FromPin) const
{
...
void UK2Node_OrbStructReferencerGet::OnBlueprintClassModified(UBlueprint* TargetBlueprint)
{
...
void UK2Node_OrbStructReferencerGet::CreateOutputPins(UClass* InClass)
{
...
void UK2Node_OrbStructReferencerGet::OnClassPinChanged()
{
	Modify();
...
void UK2Node_OrbStructReferencerGet::OnVarNamePinChanged()
{
	Modify();
...
void UK2Node_OrbStructReferencerGet::UpdateShowPinForProperties()
{
...
bool UK2Node_OrbStructReferencerGet::CheckVarExists(FOptionalPinFromProperty& Prop, UStruct * InClass)
{
	bool Out = false;
